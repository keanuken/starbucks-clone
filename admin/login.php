...
<body>
    ...
    <main>
        <form action="_logadm.php" method="post">
            <div class="container-form mt-5">
                <div class="row">
                    <div class="col hero">
                        <img src="/assets/logo.png" class="pb-3">
                        <h1 class="mb-3 title fw-bold fs-1">Admin User</h1>
                        <p>Selamat datang di dashboard Admin Starbucks Clone, silahkan login terlebih dahulu.
                        </p>
                    </div>
